...
namespace med.common.library.exception
{
    ...
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        public ApiExceptionFilterAttribute(ILogger<ApiExceptionFilterAttribute> logger, ICurrentUserService identityService)
        {
            _logger = logger;
        ...
        public override void OnException(ExceptionContext context)
        {
            ...
            _logger.LogError(context.Exception?.Message, context.Exception, _identityService);
