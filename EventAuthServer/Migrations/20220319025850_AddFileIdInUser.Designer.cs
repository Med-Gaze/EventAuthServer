...
namespace EventAuthServer.Migrations
{
    ...
    [Migration("20220319025850_AddFileIdInUser")]
    partial class AddFileIdInUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventAuthServer.Entity.AppUserModel", b =>
                {
            ...
            modelBuilder.Entity("EventAuthServer.Entity.FileDriver", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("UploadFrom")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("FileDriver");
                });

            modelBuilder.Entity("EventAuthServer.Entity.MenuModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EventAuthServer.Entity.OrganizationModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EventAuthServer.Entity.MenuModel", b =>
                {
                    b.HasOne("EventAuthServer.Entity.MenuModel", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EventAuthServer.Entity.AppUserModel", null)
                        .WithMany()
