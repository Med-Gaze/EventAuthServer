...
{
    public partial class AddAuthIntial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadFrom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ByteSize = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileDriver", x => x.Id);
                });
